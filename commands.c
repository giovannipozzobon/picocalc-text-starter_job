...
void battery()
{
    ...
    if (battery_level < 10)
    {
        printf("\033[101m"); // Set background color to red for critical battery
    }
    else if (battery_level < 30)
    {
        printf("\033[103m"); // Set background color to yellow for low battery
    }
    else
    {
        printf("\033[102m"); // Set background color to green for sufficient battery
    }
    for (int i = 0; i < battery_level / 3; i++)
    {
        printf(" "); // Print a coloured space for each 3% of battery
    }
    printf("\033[37;40m"); // Reset color
...
void box()
{
    ...
    printf("\033[93m");  // Set foreground color to bright yellow
...
void speedtest()
{
    ...
    {
        int color = 16 + (chars % 215);
        printf("\033[4;3H\033[38;5;%dm%c", color, 'A' + (chars % 26));
        chars++;
    }
